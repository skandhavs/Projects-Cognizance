    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calorietrack.food')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('all_food_selected_today', models.ManyToManyField(related_name='inventory', through='calorietrack.PostFood', to='calorietrack.food')),
                ('food_selected', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='calorietrack.food')),
                ('person_of', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='postfood',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calorietrack.profile'),
        ),
    ]
